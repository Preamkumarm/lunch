      ...
      <div className="flex flex-col w-full h-full items-center justify-between px-4 md:px-0 max-w-7xl mx-auto">
        <div className="w-full md:min-h-screen h-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-2 p-6 px-10 mt-20 md:px-16 py-4 ">
          <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
            <div className="flex items-center gap-2 justify-center bg-[#B39CD0] px-4 py-1 rounded-full">
            ...
            <p className="lg:text-[4rem] text-[2rem] font-bold tracking-wide text-white">
              ...
              <span className="text-[#B39CD0] text-[3rem] lg:text-[4.75rem]">
                Your City
              </span>
            </p>
                ...
                {heroData &&
                  heroData.map(n => (
                    <motion.div
                      ...
                      key={n.id}
                      className=" xl:w-150 w-120 sm:w-120 p-[3px] md:p-4 bg-itemBg rounded-3xl flex flex-col items-center justify-center mt-8 md:mt-10 lg:mt-0 text-center"
                      style={{
                        backdropFilter: 'blur(10px)',
                    ...
                    >
                      <img
                        src={n.imageSrc}
                        alt="icecreame1"
                        className="w-20  md:w-40 -mt-10 md:-mt-20 xl:w-[160px]"
                      />
